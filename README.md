...
| NORMAL → FIX_HEIGHT | AUX2 通道 = 0 | 双蜂鸣 (2×100ms) |
| FIX_HEIGHT → NORMAL | AUX2 通道 ≠ 0 | 单短蜂鸣 (100ms) |
...
| 机架商品图 | 机架实物图 |
|-----------|-----------|
| ![机架商品图](机架/商品图/主图_02.jpg) | ![机架实物图](机架/实物图/实物图.jpg) |
...
- [MPU6050 数据手册](Hardware/datasheet/MPU-6000 & MPU-6050 产品说明书 (中文版).pdf)
