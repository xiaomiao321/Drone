...
#define USE_GPS                  // 启用GPS功能
#define USE_GPS_UBLOX            // 启用GPS_UBLOX   
#define USE_GPS_NMEA             // 启用GPS_NMEA 
#define USE_GPS_AUTO_BAUD        // 启用自动波特率检测
#define USE_GPS_RESCUE           // 启用GPS救援模式
#define GPS_UART             SERIAL_PORT_USART3      //默认将串口3设置为GPS功能
